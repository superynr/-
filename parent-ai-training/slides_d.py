...
def d_myth(prs):
    ...
    notes(s, "이 장은 오늘 연수에서 가장 정직한 장입니다. 다른 학부모 연수에서 이 수치를 들은 분도 계실 겁니다.\n"
             ...
             "31장 ‘사실 확인 탐정’ 활동과 연결됩니다. 아이에게 가르치려는 습관을 어른이 먼저 쓴 사례라고 "
             "말씀하시면 설득력이 큽니다.")
    return s
...
def d_pisa(prs):
    ...
    notes(s, "‘기기를 쓰게 할까 말까’라는 이분법을 깨는 장입니다.\n"
             ...
             "17장 신호등의 ‘노랑’ 기준이 왜 시간이 아니라 용도인지가 여기서 설명됩니다.")
    return s
...
def d_overdep(prs):
    ...
    notes(s, "다음 장 ‘틈만 나면 AI를 찾는 아이에게’로 넘어가기 전에 배경을 깔아 주는 장입니다.\n"
             ...
             "지켜집니다. 41장 ‘우리 집 AI 사용 약속’을 쓸 때 이 점을 다시 짚어 주세요.")
    return s
...
def d_cogdebt(prs):
    ...
    notes(s, "8장 연구가 ‘시험 점수’를 봤다면, 이 장은 ‘머릿속에서 무슨 일이 일어나는가’를 봅니다. "
