...
def s05(prs):
    ...
    notes(s, "비유: ‘엄청나게 많은 글을 읽고 다음에 올 말을 아주 잘 맞히는 프로그램’. "
             ...
             "여기서 ‘환각(hallucination)’이라는 용어를 한 번만 언급하고 넘어가되, 23장에서 다시 다룬다고 예고합니다. "
...
def s06(prs):
    ...
    notes(s, "A와 B는 같은 AI, 같은 문제입니다. 다른 것은 아이가 무엇을 요청했는가뿐입니다. "
             "20장 ‘답 알려줘를 바꿔봅시다’ 활동이 바로 이 갈림길을 B로 돌리는 연습이라고 연결해 주십시오.")
    return s
