...
def s14(prs):
    ...
    footer(s, 16)
    notes(s, "신호등은 냉장고에 붙여 두기 좋은 형태입니다. 41장에서 각 가정이 직접 채웁니다.\n"
...
def s17(prs):
    ...
    notes(s, "학부모가 가장 궁금해하는 지점입니다. 핵심은 ‘무조건 안 된다’가 아니라 ‘교사가 정한 범위 안에서’입니다.\n"
             ...
             "우리 학교·우리 학년의 실제 기준은 13장의 체크리스트로 확인하는 것이 정확합니다.\n"
...
def s14a(prs):
    ...
    footer(s, 15, "출처: Google For Families 고객센터 「자녀의 Gemini 앱 사용 관리하기」",
           link=URL_GEMINI)
    notes(s, "15장에서 Gemini가 △였던 이유가 이 설정입니다. 실제로 해 보실 분들을 위한 화면입니다.\n"
             ...
             "한 번 짚어 주십시오. 41장 ‘우리 집 AI 사용 약속’에서 이 세 가지를 그대로 씁니다.")
    return s
